...
import { Breadcrumb, Button, CardSingle, Container, Footer, HasTag, Header, Input, ProfileCard, SwiperSilder, Title, TextEditor } from '../../components'
      ...
      <Container>
        ...
        <div className='flex-wrap style-guide-wrapper'>
          <div className='flex flex-col gap-2'>
            ...
            <Button type='primary' disabled>btn-primary</Button>
          </div>
          <div className='flex flex-col gap-2'>
            <h2>prefix icon</h2>
            <Button type='primary'>{Icons.userIcon} btn-primary</Button>
            <Button type='primary' disabled>{Icons.userIcon} btn-primary</Button>
          </div>
          <div className='flex flex-col gap-2'>
            <h2>suffix icon</h2>
            <Button type='primary'>btn-primary {Icons.userIcon}</Button>
            <Button type='primary' disabled>btn-primary {Icons.userIcon}</Button>
          </div>
        </div>
        ...
        <div className='flex-wrap style-guide-wrapper'>
          <div className='flex flex-col gap-2'>
            ...
            <Button type='secondary' disabled>btn-secondary</Button>
          </div>
          <div className='flex flex-col gap-2'>
            <h2>prefix icon</h2>
            <Button type='secondary'>{Icons.userIcon} btn-secondary</Button>
            <Button type='secondary' disabled>{Icons.userIcon} btn-secondary</Button>
          </div>
          <div className='flex flex-col gap-2'>
            <h2>suffix icon</h2>
            <Button type='secondary'>btn-secondary {Icons.userIcon}</Button>
            <Button type='secondary' disabled>btn-secondary {Icons.userIcon}</Button>
          </div>
        </div>
        ...
        <div className='flex-wrap style-guide-wrapper bg-[#C3C3C3]'>
          ...
          <div>
            ...
            <div className='flex flex-wrap items-center justify-center gap-10'>
              ...
              <div className='style-color-circle bg-secondary-75'>secondary-75</div>
              <div className='style-color-circle bg-secondary-50'>secondary-50</div>
              <div className='style-color-circle bg-secondary-25'>secondary-25</div>
              <div className='style-color-circle bg-secondary-10'>secondary-10</div>
              <div className='style-color-circle bg-secondary-5'>secondary-5</div>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className='flex flex-wrap items-center justify-center gap-10'>
              ...
              <div className='style-color-circle bg-white-75 text-dark'>white-75</div>
              <div className='style-color-circle bg-white-50 text-dark'>white-50</div>
        ...
        <div className='style-guide-wrapper'>
          ...
          <div className="ratio ratio-demo">
            <img src="https://images.unsplash.com/photo-1415639636295-61ae91a98b39?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="demo-img" />
          </div>
        </div>
        ...
        <div className='flex-col style-guide-wrapper'>
          ...
          <div className="grid w-full gap-5 grid-cols-3">
            ...
            <CardSingle imgParenClassName='ratio' cardTitle='Title' cardContent='Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor' isVideo
              src={avater1} />
            <div>
              <h2 className='text-center'>Profile Card</h2>
              <ProfileCard position='designer' TeamName='behzad pashaei' src={avater2} />
            </div>
          </div>
        </div>
          ...
          <div className="">
            <div className="flex flex-nowrap gap-6 ">
              {HasTagDemo.map((content, index) => (
                <HasTag className='HashtagDemo' Image={content.Image} alt={content.alt} key={index}>demo</HasTag>
              ))
              }
            </div>
          </div>
        ...
        <div className='flex-col style-guide-wrapper'>
          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <TextArea label="textarea" col="10" row='10' placeholder={'hello'} />
